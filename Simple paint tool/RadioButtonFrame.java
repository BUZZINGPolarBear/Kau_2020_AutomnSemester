...
public class RadioButtonFrame extends JFrame{
    ...
    public RadioButtonFrame(){
        ...
        mainPaint.radioBtnPanel.add(px3BTN);
        mainPaint.radioBtnPanel.add(px5BTN);
        mainPaint.radioBtnPanel.add(px8BTN);
        mainPaint.radioBtnPanel.add(px12BTN);
        mainPaint.radioBtnPanel.add(px16BTN);
        mainPaint.radioBtnPanel.add(px20BTN);
